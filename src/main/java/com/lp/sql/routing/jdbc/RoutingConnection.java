...
public class RoutingConnection extends AbstractConnectionAdapter implements RoutingContextClearable {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql)));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql) , resultSetType , resultSetConcurrency));
    }


    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql) , resultSetType , resultSetConcurrency , resultSetHoldability));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql) , autoGeneratedKeys));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql) , columnIndexes));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(getNativeSql(sql) , columnNames));
    }
