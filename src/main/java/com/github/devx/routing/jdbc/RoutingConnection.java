 ...
 * @since 1.0
 */
public class RoutingConnection extends AbstractConnectionAdapter implements RoutingContextAccessible {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql)));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql) , resultSetType , resultSetConcurrency));
    }


    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql) , resultSetType , resultSetConcurrency , resultSetHoldability));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql) , autoGeneratedKeys));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql) , columnIndexes));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return newPreparedStatement(preparedConnection(sql).prepareStatement(nativeSQL(sql) , columnNames));
    }
